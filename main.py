...
def show_post(post_id):
    ...
    if comment_form.validate_on_submit():
        ...
        db.session.commit()
    return render_template("post.html", post=requested_post,logged_in=current_user.is_authenticated,form=comment_form,user=current_user,gravatar=gravatar)
...
def add_new_post():
    ...
    return render_template("make-post.html", form=form, logged_in=current_user.is_authenticated, is_edit=False, is_admin=is_admin)
...
def edit_post(post_id):
    ...
    is_admin = current_user.is_authenticated and current_user.id == 1
    return render_template("make-post.html", form=edit_form, is_edit=True, logged_in=current_user.is_authenticated, is_admin=is_admin)
